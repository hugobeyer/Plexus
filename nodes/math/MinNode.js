...
class MinNode extends AtomicNode {
    constructor() {
        super();
        ...
        this.addOutput('out', 'float', 'Min(A,B)');
        
        // Pure compute function
        this.compute = (a, b) => Math.min(a, b);
    ...
    // Custom fragment shader - downward arrow
    getFragmentShader() {
        return `
